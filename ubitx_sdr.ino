...
/**
  For the SDR, we set the frequency in a very simple way.
  The crysal ladder filter has a steep notch on the higher side,
  hence, the bfo (in the usbCarrier variable) is seth to 27.031 MHz.
  The passband of 25 KHz in the ladder filter is centered around
  27.007 KHz, 
  the baseband output read in by the sdr's codec
  is from 27.007 + 12.5 KHz to 27.007 - 12.5 Khz
  27.020 to 26.995 KHz
 */
